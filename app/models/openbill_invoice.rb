class OpenbillInvoice < OpenbillRecord
  ...
  def amount_in_words
    ...
    buffer[0].mb_chars.capitalize.to_s + buffer[1..-1]
  end
  ...
  def make_notification?
    ...
    return true unless client_notified_at.present?
